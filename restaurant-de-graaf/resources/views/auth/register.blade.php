            ...
            <div class="col-md-8">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tel_number" class="col-md-4 col-form-label text-md-right">{{ __('Telefoonnummer') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="no_robot" class="col-md-4 col-form-label text-md-right">{{ __('Ik ben geen robot') }}</label>

                            <div class="col-md-6">
                                <input id="no_robot" type="checkbox" class="defaultCheckbox" name="no_robot" required autocomplete="no_robot">
                                @error('no_robot')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
